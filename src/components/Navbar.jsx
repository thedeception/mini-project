      ...
      <div className="navbar justify-between bg-primary-content text-neutral-focus">
        ...
        <div className="md:hidden md:order-2 ">
          <div className="dropdown dropdown-bottom ">
            ...
            <ul
              tabIndex={0}
              className="menu menu-compact bg-neutral-50 dropdown-content  p-2 shadow bg-base-100 rounded-box w-52"
            >
              <li tabIndex="0">
                ...
                <ul className=" bg-primary-content text-neutral-focus">
                  ...
                  <li>
                    <a className="btn btn-ghost">From: {from}</a>
                  </li>
                  <li>
                    <a className="btn btn-ghost">to: {to}</a>
                  </li>
                </ul>
              </li>
              <li tabIndex="0">
                ...
                <ul className=" bg-primary-content text-neutral-focus">
                  <li>
                    <a className="btn btn-ghost">Submenu 1</a>
                  </li>
                  <li>
                    <a className="btn btn-ghost">Submenu 2</a>
                  </li>
                </ul>
              </li>
              <li tabIndex="0">
        ...
        <div className="hidden md:block order-2">
          <ul className="menu menu-horizontal px-1">
            ...
            <li tabIndex="0">
              ...
              <ul className=" bg-primary-content text-neutral-focus">
                <li>
                  <a className="btn btn-ghost">Total Recipes: {totalRecipes}</a>
                </li>
                <li>
                  <a className="btn btn-ghost">From: {from}</a>
                </li>
            ...
            <li>
              <a className="btn-ghost font-semibold">Buy</a>
            </li>
          </ul>
        </div>
